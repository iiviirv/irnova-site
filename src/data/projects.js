...
export const projects = [
  ...
  },
  {
    ...
    description: {
      en: 'Turn any VPS into a full Nova server with a one-line installer, then connect in a single QR scan. A complete xray and sing-box panel with VLESS, VMess, Trojan, Shadowsocks, Reality, Hysteria2 (with UDP port hopping and ECH to hide the SNI), TUIC, NaiveProxy, WireGuard, and AmneziaWG, plus per-user quotas and expiry, smart routing, clean-IP outbound, Iran bridge tunnels with automatic failover across several bridges, a last-resort DNS tunnel (MasterDnsVPN or CottenDns), outbound webhooks, and a login guard, all managed from a trilingual dashboard.',
      fa: 'هر سرور مجازی را با یک نصب‌کننده‌ی تک‌خطی به یک سرور کامل نوا تبدیل کن و با یک بار اسکن QR وصل شو. یک پنل کامل xray و sing-box با VLESS، VMess، Trojan، Shadowsocks، Reality، Hysteria2 (با پرش پورت UDP و ECH برای پنهان‌کردن SNI)، TUIC، NaiveProxy، WireGuard و AmneziaWG، به‌همراه سهمیه و انقضای هر کاربر، مسیریابی هوشمند، خروجی آی‌پی تمیز، تونل‌های پل ایران با جابه‌جایی خودکار میان چند پل، تونل DNS به‌عنوان آخرین راه (MasterDnsVPN یا CottenDns)، وب‌هوک خروجی و نگهبان ورود، همه از یک داشبورد سه‌زبانه.',
    },
    language: 'Node.js',
    stars: 1,
    url: 'https://github.com/IRNova/Nova-Server',
    tags: {
      en: ['Self-hosted', 'Reality', 'Hysteria2', 'Port Hopping', 'ECH', 'Bridge Failover', 'WireGuard', 'DNS Tunnel'],
      fa: ['خودمیزبان', 'Reality', 'Hysteria2', 'پرش پورت', 'ECH', 'پل جایگزین', 'WireGuard', 'تونل DNS'],
    },
    featured: true,
  },
  {
