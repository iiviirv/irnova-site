...
export const ui = {
  en: {
    ...
    tools: {
      title: 'IP Formatter',
      intro:
        'Paste your clean IPs or domains and get them formatted as ADDRESS:PORT#name lines, ready to import into your client. Everything runs in your browser, nothing is sent anywhere.',
      portsLabel: 'Ports',
      portsTls: 'TLS ports',
      portsNonTls: 'Non-TLS ports',
      portsHint: 'Tap to include or exclude a port. TLS ports use security=tls; non-TLS ports are for non-TLS mode.',
  ...
  fa: {
    ...
    tools: {
      ...
      intro:
        'آی‌پی‌های تمیز یا دامنه‌های خود را بچسبانید تا به‌صورت خطوط ADDRESS:PORT#name آماده‌ی وارد کردن در کلاینت تبدیل شوند. همه‌چیز در مرورگر شما اجرا می‌شود، هیچ داده‌ای به جایی ارسال نمی‌شود.',
      portsLabel: 'پورت‌ها',
      portsTls: 'پورت‌های TLS',
      portsNonTls: 'پورت‌های بدون TLS',
      portsHint: 'برای افزودن یا حذف یک پورت روی آن بزنید. پورت‌های TLS برای security=tls و پورت‌های بدون TLS برای حالت بدون TLS هستند.',
