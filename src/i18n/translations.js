    ...
    deploy: {
      ...
      steps: [
        ...
        },
        {
          ...
          text: 'In your free Cloudflare account, create a Worker, paste in the .js and Deploy, then add a KV namespace bound with the name KV.',
        },
        {
    ...
    deploy: {
      ...
      steps: [
        ...
        },
        {
          ...
          text: 'در حساب رایگان کلودفلرت یک Worker بساز، فایل .js را بچسبان و Deploy کن، سپس یک فضای KV با نام KV به آن متصل کن.',
        },
        {
