...
export const ui = {
  en: {
    ...
    deploy: {
      ...
      sub: 'It runs on your own free Cloudflare account — no CLI, no API token, no keys to manage. Three steps and you have a private subscription link and QR to share.',
      cta: 'Deploy to Cloudflare',
      steps: [
        {
          title: 'Click & authorize Cloudflare',
          text: 'The Deploy button logs you into Cloudflare (no API token), forks the repo, creates the Worker, auto-creates the KV namespace, and bundles the dashboard — all automatically.',
        },
        {
          title: 'Open your Worker URL & set a password',
          text: 'A setup wizard appears at /install with the KV database already green. Just type an admin password and click “Create password”.',
        },
        {
          title: 'Log in & share your link',
          text: 'You’re sent to /login. Sign in and the panel shows your subscription link and QR — import it into any client and you’re online.',
        },
      ],
  ...
  fa: {
    ...
    deploy: {
      ...
      sub: 'روی حساب رایگان کلودفلر خودت اجرا می‌شود — بدون خط فرمان، بدون توکن API و بدون هیچ کلیدی برای مدیریت. با سه قدم، یک لینک اشتراک خصوصی و QR برای به اشتراک گذاشتن خواهی داشت.',
      cta: 'استقرار روی کلودفلر',
      steps: [
        {
          title: 'کلیک کن و به کلودفلر اجازه بده',
          text: 'دکمه‌ی استقرار تو را وارد کلودفلر می‌کند (بدون توکن API)، مخزن را فورک می‌کند، ورکر را می‌سازد، فضای KV را به‌صورت خودکار ایجاد می‌کند و داشبورد را داخل ورکر قرار می‌دهد — همه‌چیز خودکار.',
        },
        {
          title: 'آدرس ورکرت را باز کن و یک رمز بگذار',
          text: 'یک راهنمای راه‌اندازی در آدرس /install باز می‌شود که دیتابیس KV از قبل سبز است. کافی است یک رمز مدیر تایپ کنی و روی «Create password» بزنی.',
        },
        {
          title: 'وارد شو و لینکت را به اشتراک بگذار',
          text: 'به /login هدایت می‌شوی. وارد شو و پنل، لینک اشتراک و QR تو را نشان می‌دهد — آن را در هر کلاینتی وارد کن و آنلاین شو.',
        },
      ],
