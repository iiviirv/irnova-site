...
export const ui = {
  en: {
    ...
    guidePage: {
      ...
      titleAccent: 'guides',
      subtitle:
        'Everything you need to install, set up, and run Nova, from the first click to day-to-day operation. Pick a product below, or search across the guide.',
      proxyLabel: 'Nova Proxy',
      serverLabel: 'Nova Server',
      proxyTagline: 'Free, on Cloudflare',
      serverTagline: 'Self-hosted VPS',
    ...
    netStatus: {
      eyebrow: 'Live from inside Iran',
      title: 'What is reachable right now',
      desc: 'Probes on Iranian ISPs and Cloudflare\u2019s edge check the same sites every few minutes. The gap between the two is the filtering.',
      reachable: 'reachable in Iran',
      blocked: 'blocked in Iran',
      checked: 'sites checked',
  ...
  fa: {
    ...
    guidePage: {
      ...
      titleAccent: 'نوا',
      subtitle:
        'هر آنچه برای نصب، راه‌اندازی و مدیریت نوا لازم دارید، از اولین کلیک تا استفاده روزانه. یکی از دو محصول را انتخاب کنید یا داخل راهنما جستجو کنید.',
      proxyLabel: 'Nova Proxy',
      serverLabel: 'Nova Server',
      proxyTagline: 'رایگان، روی کلادفلر',
      serverTagline: 'خودمیزبان روی VPS',
      searchPlaceholder: 'جستجو در این راهنما...',
      searchLabel: 'جستجو در راهنما',
      toc: 'در این صفحه',
      faqTag: 'سوال',
      sectionTag: 'بخش',
    ...
    novaProxy: {
      ...
      intro:
        'نوا پراکسی بخش رایگان و بدون‌سرور نوا است: یک پراکسی شخصی و مقاوم در برابر سانسور که به‌طور کامل روی ورکر رایگان کلودفلر خودت اجرا می‌شود. با یک کلیک مستقر کن، در مرورگر یک رمز بگذار و لینک اشتراکت را به اشتراک بگذار. بدون خط فرمان و بدون سروری که باید زنده نگهش داری.',
    ...
    netStatus: {
      eyebrow: 'زنده از داخل ایران',
      title: 'همین حالا چه چیزی باز است',
      desc: 'پروب‌هایی روی اپراتورهای ایران و شبکهٔ \u2066Cloudflare\u2069 هر چند دقیقه یک‌بار همان سایت‌ها را بررسی می‌کنند. فاصلهٔ این دو، همان فیلترینگ است.',
      reachable: 'باز در ایران',
      blocked: 'مسدود در ایران',
      checked: 'سایت بررسی‌شده',
      abroad: 'باز از خارج',
